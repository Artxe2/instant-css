...
import MapAbbr from "src/components/cells/texts/MapAbbr.svelte"

let fold = true
</script>

<svelte:head>
	<title>Key Abbreviation - Instant CSS</title>
</svelte:head>

<H5>Key Abbreviation</H5>
<div class="h=1"></div>
<span>Key Abbreviations of InstantCSS.</span><br />
<!-- InstantCSS의 키 약어입니다. -->
<div class="h=2"></div>
<CodePage>
	<div class="flex">
	...
	<div class={fold ? ">pre>span>c/block;m=-1.5;hidden" : ""}>
		<MapAbbr
			name="abbrKeys" 
			json={`[
	["acc","accent-color"],
